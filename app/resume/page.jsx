...
const about = {
  title: "About Me",
  description:
    "I am a Full Stack Developer with a passion for creating beautiful and functional websites. I have experience in building websites and web applications using modern technologies like React, Node.js, and MongoDB. I am also proficient in UI/UX design and have experience working with tools like Figma and Adobe XD.",
  info: [
    {
      fieldName: "Name",
      fieldValue: "Adoum Salah",
    },
    {
      fieldName: "phone",
      fieldValue: "(+33) 7 81 31 15 41",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "sadoumachi@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  items: [
    ...
    {
      company: "SoftwareDevelopment Firm",
...
function Resume() {
  return (
    <motion.div
      ...
      animate={{
        opacity: 1,
        transition: { delay: 2.4, duration: 0, ease: "easeIn" },
      }}
